        ...
        if st.button("Generate", type="primary"):
            if not api_key:
                ...
                with st.spinner("AI is crafting your scenario..."):
                    ...
                    if json_str:
                        # Clean string before parsing (remove markdown fences if present)
                        ...
                        try:
                            ...
                            st.error(f"Scenario generation was incomplete or malformed (JSON Error). The scenario might be too complex for the output limit. Please try again with a simpler request or fewer constraints.")
